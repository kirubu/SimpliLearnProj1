...
public class LockerIndustry {
	...
	public static void main(String[] args) {
		...
		String rootDirPath = "C:\\Users\\Admin\\Pictures\\simplilearn Proj";
		boolean result = true;
		do
		{
			displayMenu();
			...
			case 2:
				...
				switch(subChoice)
				{
					...
					break;
					default:
						System.out.println("You Entered incorrect choice...Enter choice between 1 to 3");
					break;
				}
			break;
			case 3:
	...
	private static void searchFile(String rootDirPath, String fileName) 
	{
		...
		if (rootDir.exists() && rootDir.isDirectory()) 
        {
			...
			for(int i=0;i<rootDirArr.length;i++)
			{
				...
				{
					fileNotFound = false;
					System.out.println(fileName+" is founded in path "+rootDirPath);
					i = rootDirArr.length;
				}
			}
		}
